...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "India's unified school platform for communication, live classes, meetings, notices, and academic coordination.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "HermesWorkspace — Every school. One platform.",
    description:
      "India's all-in-one school platform: live classes, messaging, notices, meetings & more.",
...
const organizationSchema = {
  ...
  description:
    "HermesWorkspace is the all-in-one school management and communication platform built for India's educational institutions.",
  foundingDate: "2024",
  foundingLocation: {
    "@type": "Place",
  ...
  contactPoint: [
    ...
    },
    {
      "@type": "ContactPoint",
      contactType: "sales",
      email: "connect@hermesworkspace.com",
    },
  ],
  sameAs: [
...
const websiteSchema = {
  ...
  name: "HermesWorkspace",
  description:
    "Every school. One platform. India's unified school communication and management platform.",
...
const softwareApplicationSchema = {
  ...
  url: BASE_URL,
  description:
    "All-in-one school management and communication platform for CBSE, ICSE, and State Board schools in India. Features include live HD classes, parent-teacher messaging, digital notice board, meeting scheduler, and institutional analytics.",
  offers: {
    "@type": "Offer",
    price: "0",
    priceCurrency: "INR",
    description: "Free demo available for qualifying institutions.",
  },
  publisher: { "@id": `${BASE_URL}/#organization` },
  featureList: [
    "Live HD video classes",
    "Institutional messaging and channels",
    "Digital notice board with delivery tracking",
    "Parent-teacher communication",
    "Meeting and webinar scheduler",
    "Role-based access control",
    "School-wide analytics dashboard",
    "CBSE/ICSE/State Board compatible",
  ],
