...
=======
    <html lang="en-IN">
      <body className="m-0 min-h-screen flex flex-col items-center justify-center bg-[#FAFAFA] font-sans px-6">
        <main className="flex flex-col items-center text-center max-w-[420px]">
          <Link
            href="/"
            className="flex items-center gap-3 mb-8 no-underline text-inherit"
            aria-label="HermesWorkspace home"
