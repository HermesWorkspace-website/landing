...
import {
  ...
  Mic, Monitor, PhoneCall, ChevronLeft, ChevronRight
} from "lucide-react";
...
// ─── ANIMATED COUNTER (IntersectionObserver — won't fire before visible) ─────
        ...
        <div className="flex items-center gap-4 mb-5">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1.5">
              <span className="px-2 py-0.5 rounded-full bg-green-500/10 text-green-600 text-[9px] font-bold">ONLINE</span>
    ...
    <div className="h-full flex flex-col gap-3">
      ...
      <div className="flex-1 grid grid-cols-3 gap-3">
        {NOTICE_LIST.map((n, i) => (
          ...
          >
            <div className="absolute top-0 left-0 w-1 h-full rounded-tl-2xl rounded-bl-2xl" style={{ background: n.color }} />
    ...
    <section ref={sectionRef} className="relative overflow-hidden bg-brand-bg">
      ...
      >
        <div className="relative">
          <DashboardMock />
          <div className="absolute bottom-0 left-0 right-0 h-16 rounded-b-[14px] pointer-events-none" style={{ background: "linear-gradient(to bottom, transparent, var(--color-brand-bg, #ffffff))" }} />
          <div className="float-card absolute -top-5 -left-4 md:-left-10 hidden md:block z-20">
            <FloatingCard className="flex items-center gap-3" delay={2}>
              <div className="size-9 rounded-full bg-red-500/10 flex items-center justify-center flex-shrink-0"><Video className="size-4 text-red-500" /></div>
              <div>
