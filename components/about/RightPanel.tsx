  ...
  return (
    <AnimatePresence mode="wait">
      <m.div
        ...
        animate="show"
        exit="exit"
        className="flex flex-col justify-center py-8 pr-6 lg:pr-9 pl-4 text-right"
      >
        {/* Top header */}
        ...
        <div className="my-auto">
          ...
          <m.p
            ...
            className="text-[13px] leading-[1.65] text-[#444] italic ml-auto font-display"
            style={{ maxWidth: "clamp(180px, 16vw, 300px)" }}
          >
            {founder.quote}
          </m.p>
        </div>
        ...
        <div className="space-y-4">
          ...
          >
            <p className="text-[9px] tracking-[3px] uppercase text-[#7A7A85] mb-1.5">Up Next</p>
            <p className="text-[11px] tracking-[1px] text-[#0D0D0F] font-medium">
              {nextFounder.firstName} {nextFounder.lastName}
            </p>
            <p className="text-[9px] tracking-[1px] uppercase text-[#7A7A85]">{nextFounder.title}</p>
          </m.div>
