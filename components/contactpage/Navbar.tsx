  ...
  return (
    ...
    >
      <div className="container-page h-[56px] md:h-[60px] flex items-center justify-between">
        {/* Logo */}
        <a href="/" className="flex items-center gap-2.5 group" aria-label="HermesWorkspace home">
            ...
            <div className="container-page py-6 flex flex-col gap-4">
              {mainLinks.map((l, i) => (
                <motion.a
                  ...
                  className="text-base font-medium text-brand-ink/70 hover:text-brand-ink transition-colors"
