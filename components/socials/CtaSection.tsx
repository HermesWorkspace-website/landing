...
export function CtaSection() {
  ...
  return (
    <section id="contact" className="py-28 bg-[#F9F8FF] relative overflow-hidden" ref={ref}>
      ...
      {/* Gradient blobs */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-[#6B5CE7]/5 blur-3xl" />
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <motion.p
            variants={fadeUp}
            className="text-[10px] tracking-[3px] uppercase text-[#6B5CE7] font-medium mb-5"
          >
          ...
          <motion.h2
            variants={fadeUp}
            className="text-[clamp(36px,5vw,64px)] font-black text-[#0D0D0F] leading-[1.05] tracking-tight mb-6"
          ...
          >
            <motion.a
              ...
              whileHover={{
                scale: 1.05,
                boxShadow: "0 16px 50px rgba(107,92,231,0.4)",
              }}
              whileTap={{ scale: 0.97 }}
              className="flex items-center gap-2.5 bg-[#6B5CE7] text-white text-[13px] font-semibold px-7 py-3.5 rounded-full"
            >
              Connect With Us
              <ArrowRight size={14} />
            </motion.a>
  ...
  whileTap={{ scale: 0.97 }}
  className="flex items-center gap-2.5 text-[#0D0D0F] text-[13px] font-medium px-7 py-3.5 rounded-full border border-[#D8D4CC] hover:border-[#6B5CE7] transition-colors"
>
